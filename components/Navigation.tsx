        ...
        <div className="flex items-center h-full relative">
          ...
          >
            ...
            {!isScrolled && (
              ...
              >
                <div className="text-lg md:text-xl lg:text-2xl font-heading font-bold text-white drop-shadow-lg leading-tight">
                  MÄSTER JACOBS
                </div>
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6 flex-1 justify-end">
            ...
            >
              ...
              <span className={`ml-2 font-body text-sm ${isScrolled ? 'text-black' : 'text-white'} group-hover:text-gold transition-all duration-300`}>Sök produkter</span>
            </motion.div>
            ...
            >
              ...
              <span className={`font-body text-sm ${isScrolled ? 'text-black' : 'text-white'} group-hover:text-gold transition-all duration-300`}>Varukorg</span>
              <motion.div 
