...
const instagramPosts = [
  ...
  },
  {
    ...
    text: "Vår passion för bakverk – direkt till ditt bord",
      ...
      >
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-stretch">
            ...
            >
              <iframe
                src="https://www.google.com/maps?q=Pettersbergsgatan%2037%2C%20723%2042%20V%C3%A4ster%C3%A5s%2C%20Sverige&output=embed"
                className="w-full h-full"
                style={{ border: 0, minHeight: "400px" }}
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Mäster Jacobs Bageri – Pettersbergsgatan 37, Västerås, Sverige"
                aria-label="Karta: Pettersbergsgatan 37, Västerås, Sverige"
                allowFullScreen
              ></iframe>
